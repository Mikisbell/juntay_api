    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-4 space-y-4">
                <Card className="sticky top-20 border-2 border-slate-200 shadow-xl">
                    <CardHeader className="bg-slate-50 border-b">
                        <CardTitle className="text-lg">Resumen Operación</CardTitle>
                    </CardHeader>
                    <CardContent className="pt-6 space-y-6">
                        ...
                        {/* Botón Acción */}
                        <Button
                            className={`w-full h-14 text-lg shadow-md transition-all ${cajaAbierta
                            ...
                            {cajaAbierta ? (
                                <span className="flex flex-col items-center leading-tight">
                                    <span className="font-bold flex items-center gap-2">
                                        <DollarSign className="w-5 h-5" /> DESEMBOLSAR
                                    </span>
                                    <span className="text-[10px] opacity-90 font-normal">
                                        Crear + Pagar + Imprimir
                                    </span>
                                </span>
                            ) : (
                                <span className="flex flex-col items-center leading-tight">
                        ...
                        {!cajaAbierta && (
                            <div className="flex items-start gap-2 p-3 bg-amber-50 text-amber-800 text-xs rounded-lg">
