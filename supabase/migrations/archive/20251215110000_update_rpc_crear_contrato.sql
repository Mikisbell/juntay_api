-- 🔧 Actualización del RPC crear_contrato_oficial para corregir "Missing empresa_id"
-- Versión: 3.2
-- Fecha: 2025-12-15
-- Cambio: Insertar explícitamente empresa_id en la tabla creditos para evitar datos huérfanos.
