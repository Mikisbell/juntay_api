-- Corrige el estado inválido 'liberada' por 'devuelta' en registrar_pago_oficial
-- Fecha: 2025-12-15 13:00
...
BEGIN
    ...
    -- 3. REGISTRAR EL PAGO (Historial) - MOVED UP before Update to avoid "Control de Estado" trigger
    ...
    ELSIF p_tipo_operacion = 'DESEMPENO' THEN
        ...
        -- Liberar garantía automáticamente (FIX: 'devuelta' es el estado válido)
        UPDATE public.garantias 
        SET estado = 'devuelta',
            fecha_venta = NOW() -- Opcional, marcar fecha de devolución
