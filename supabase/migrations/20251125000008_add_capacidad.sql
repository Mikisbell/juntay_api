-- 1. Add 'capacidad' column to garantias table
ALTER TABLE public.garantias 
ADD COLUMN IF NOT EXISTS capacidad VARCHAR(100);

-- 2. Update RPC to handle 'capacidad'
...
BEGIN
    ...
    -- 3. CREAR GARANTÍA (Con todos los campos nuevos + CAPACIDAD)
    INSERT INTO public.garantias (
        ...
        (p_garantia_data->>'valorMercado')::DECIMAL,
        'custodia',
        -- Valores procesados
        ...
        p_garantia_data->>'capacidad', -- NUEVO CAMPO
    ...
    INSERT INTO public.creditos (
        ...
        p_caja_id,
        v_monto_prestamo,
        (p_contrato_data->>'tasaInteres')::DECIMAL,
        (p_contrato_data->>'dias')::INT,
        (p_contrato_data->>'fechaVencimiento')::DATE,
        v_monto_prestamo,
        'vigente'
