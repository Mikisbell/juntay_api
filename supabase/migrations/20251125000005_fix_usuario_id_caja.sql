-- FIX: Agregar usuario_id al registro de movimientos de caja operativa
-- Este parche corrige el error "null value in column usuario_id violates not-null constraint"
